...
import (
	...
	"github.com/flant/negentropy/vault-plugins/flant_iam/extensions/ext_flant_flow/backend"
	url2 "github.com/flant/negentropy/vault-plugins/flant_iam/extensions/ext_flant_flow/backend/tests/url"
)
...
func NewClientAPI(b *logical.Backend) TestAPI {
	return &BackendBasedAPI{backend: b, url: &url2.ClientEndpointBuilder{}}
}

func NewTeamAPI(b *logical.Backend) TestAPI {
	return &BackendBasedAPI{backend: b, url: &url2.TeamEndpointBuilder{}}
}

func NewTeammateAPI(b *logical.Backend) TestAPI {
