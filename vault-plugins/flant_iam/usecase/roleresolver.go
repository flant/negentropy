...
func (r *roleResolver) IsUserSharedWith(model.TenantUUID) (bool, error) {
	panic("implement me")
}

func (r *roleResolver) IsServiceAccountSharedWith(model.TenantUUID) (bool, error) {
	panic("implement me")
}
...
func (r *roleResolver) CheckGroupForRole(model.GroupUUID, model.RoleName) (bool, error) {
	panic("implement me")
}
