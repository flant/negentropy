...
//		t.Parallel()
//
//		// normal cases, both passing the authMethodConfig name explicitly and relying on the default
...
//	})
//
//	t.Run("missing authMethodConfig", func(t *testing.T) {
//		t.Parallel()
//
//		data := map[string]interface{}{
//			"authMethodConfig":         "not_a_role",
//			"redirect_uri": "https://example.com",
//		}
//		req := &logical.Request{
//			Operation: logical.UpdateOperation,
...
//	})
//
//	// create limited authMethodConfig with restricted redirect_uris
//	req = &logical.Request{
//		Operation: logical.CreateOperation,
//		Path:      "authMethodConfig/limited_uris",
//		Storage:   storage,
//		Data: map[string]interface{}{
//			"role_type":             "oidc",
//			"user_claim":            "email",
...
//		expectErr      bool
//	}{
//		"auth URL for authMethodConfig with integer max_age of 60": {
//			maxAge:         "60",
//			expectedMaxAge: "60",
//		},
//		"auth URL for authMethodConfig with integer max_age of 180": {
//			maxAge:         "180",
//			expectedMaxAge: "180",
//		},
//		"auth URL for authMethodConfig with empty max_age": {
//			maxAge:         "",
//			expectedMaxAge: "",
//		},
//		"auth URL for authMethodConfig with duration string max_age of 30s": {
//			maxAge:         "30s",
//			expectedMaxAge: "30",
//		},
//		"auth URL for authMethodConfig with duration string max_age of 2m": {
//			maxAge:         "2m",
//			expectedMaxAge: "120",
//		},
//		"auth URL for authMethodConfig with duration string max_age of 1hr": {
//			maxAge:         "1h",
//			expectedMaxAge: "3600",
//		},
//		"auth URL for authMethodConfig with invalid duration string": {
//			maxAge:    "1hr",
//			expectErr: true,
//		},
//		"auth URL for authMethodConfig with invalid signed integer": {
//			maxAge:    "-1",
//			expectErr: true,
//		},
//	}
...
//		t.Run(name, func(t *testing.T) {
//			// Write the authMethodConfig with the given max age
//			req = &logical.Request{
//				Operation: logical.CreateOperation,
//				Path:      "authMethodConfig/test",
//				Storage:   storage,
...
//
//		s.customClaims = sampleClaims(nonce)
//		s.customClaims["sk"] = "43" // the pre-configured authMethodConfig has a bound claim of "sk"=="42"
//
//		// set mock provider's expected code
//		s.code = "abc"
//
