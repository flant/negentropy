...
//		}
//		if !strings.Contains(resp.Error().Error(), "authMethodConfig with oidc role_type is not allowed") {
...
//			t.Fatal("expected error")
//		}
//		if !strings.Contains(resp.Error().Error(), "no audiences bound to the authMethodConfig") {
//			t.Fatalf("unexpected error: %v", resp.Error())
//		}
//	}
//
...
//			metadata["authMethodConfig"] = "plugin-test"
...
//	}
//
//	// test bad authMethodConfig name
//	{
//		jwtData, _ := getTestJWT(t, ecdsaPrivKey, sqjwt.Claims{}, struct{}{})
//
//		data := map[string]interface{}{
//			"authMethodConfig": "plugin-test-bad",
//			"jwt":  jwtData,
//		}
//
//		req := &logical.Request{
...
//			t.Fatal("expected error")
//		}
//		if resp.Error().Error() != `authMethodConfig "plugin-test-bad" could not be found` {
...
//
//			// Configure a JWT authMethodConfig
//			data = map[string]interface{}{
//				"role_type":       "jwt",
