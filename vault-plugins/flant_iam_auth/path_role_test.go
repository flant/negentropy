...
//	})
//
//	t.Run("authMethodConfig with invalid glob in claim", func(t *testing.T) {
//		b, storage := getBackend(t)
//		data := map[string]interface{}{
//			"role_type":         "jwt",
//			"user_claim":        "user",
...
//	readTest()
//
//	// Remove the 'role_type' parameter in stored authMethodConfig to simulate a legacy authMethodConfig
