...
import (
	...
	"github.com/flant/negentropy/e2e/tests/lib/identitysharing"
	"github.com/flant/negentropy/e2e/tests/lib/rolebinding"
	"github.com/flant/negentropy/e2e/tests/lib/rolebindingapproval"
	"github.com/flant/negentropy/e2e/tests/lib/tenant"
	tenant_featureflag "github.com/flant/negentropy/e2e/tests/lib/tenant-featureflag"
	"github.com/flant/negentropy/e2e/tests/lib/tools"
	"github.com/flant/negentropy/e2e/tests/lib/user"
)
