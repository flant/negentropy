...
def upgrade(vault_name: str, vaults: List[Vault]):
    ...
    vault.client.write(path='auth/flant/kafka/configure', peers_public_keys=public_key,
                       self_topic_name='auth_source.' + vault.name, root_topic_name='root_source.' + vault.name,
