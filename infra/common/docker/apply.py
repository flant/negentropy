...
def main():
    ...
    if args.type == 'configurator':
        for vault in vault_list_with_status:
            ...
            upgrade_db_command(type('obj', (object,), {'migration_dir' : '../../configurator/vault_migrations/%s' % vault['name'], 'version' : args.target_migration_version}))
        ...
        for vault in vault_root_source_list:
            ...
            if status['is_self'] == False:
                vault_root_source_standby_list.append(vault)
        print('DEBUG: vault_root_source_standby_list is', vault_root_source_standby_list)

        vault_list_for_migrations = [vault for vault in vault_list_with_status if vault['name'] not in vault_root_source_standby_list]
        ...
        for vault in vault_list_for_migrations:
            ...
            upgrade_db_command(type('obj', (object,), {'migration_dir' : '../../main/vault_migrations/%s' % vault['name'], 'version' : args.target_migration_version}))
