...
go mod edit -require github.com/flant/negentropy/vault-plugins/flant_flow@v0.0.0 -replace github.com/flant/negentropy/vault-plugins/flant_flow@v0.0.0=../../../../vault-plugins/flant_flow
