resource "google_service_account" "terraform" {
  ...
  display_name = "A service account for run terraform apply on vault-conf and vault-conf_conf instances"
}
...
# resource "google_project_iam_member" "terraform-role-admin" {
#   project = data.google_project.project.project_id
